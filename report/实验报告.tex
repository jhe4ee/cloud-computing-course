...
\textbf{注：} 因 CCE 集群节点规模有限（3节点，最低 2vCPU/4GB），Grafana Dashboard 已成功部署并通过健康检查验证。完整的 CPU/内存 Dashboard 图表可在 port-forward 暴露 Grafana 服务后通过浏览器访问 \texttt{http://localhost:3000} 查看。
