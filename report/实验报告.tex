...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{task1-docker-compose-curl.png}
\caption{Docker Compose 本地联调 + curl /api/ping 测试}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{task1-swr-images.png}
\caption{SWR 镜像仓库列表（backend:v1, frontend:v1）}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{task2-kubectl-get-nodes.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{task3-kubectl-get-pods-running.png}
\caption{kubectl get pods（全 Running）}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{task3-curl-elb-ping.png}
\caption{curl ELB 公网 IP /api/ping 返回 \{"status":"ok"\}}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{task4-pvc-bound-set-get.png}
\caption{PVC Bound + SET testkey / GET testkey 验证写入}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{task4-pvc-delete-pod-get-hello.png}
\caption{删除 Redis Pod 后新 Pod 仍返回 "hello"（持久化成功）}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{task5-configmap-listen-8080.png}
\caption{ConfigMap Volume 挂载：nginx.conf 端口更新为 listen 8080}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{task6-hpa-scale-up.png}
\caption{HPA 扩容：Pod 数从 1 扩展到 4}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{task6-hpa-scale-down.png}
\caption{HPA 缩容：Pod 数恢复至 1}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{a0-wordcount-pod-completed.png}
\caption{WordCount Driver Pod 状态变为 Completed}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{a0-wordcount-top10-words.png}
\caption{WordCount 日志输出：Top 10 words 结果}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{a1-data-cleaning-stats.png}
\caption{数据清洗：Schema + 缺失值统计 + 清洗前后行数对比}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{a1-data-cleaning-result.png}
\caption{清洗后数据统计（describe 结果）}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{a2-sql-queries.png}
\caption{A-2 四个 Spark SQL 查询结果（GROUP BY / Top-N / 趋势 / 窗口函数）}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{a3-performance-compare.png}
\caption{A-3 性能对比：PySpark local[1] 7.46s vs local[2] 2.03s}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{bonus1-monitoring-pods.png}
\caption{监控命名空间全部 Pod 状态为 Running}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{bonus1-grafana-health.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{bonus2-cicd-actions-passed.png}
\caption{GitHub Actions CI/CD 流水线全部 Passed}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{bonus2-cicd-details.png}
\caption{CI/CD 流水线各步骤详情}
\end{figure}
